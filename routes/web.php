...
Route::prefix('undangan')->name('undangan.')->group(function(){
    ...
    Route::post('/add-rsvp', [InvitationController::class, 'storeRsvp'])->name('add-rsvp');
    Route::post('/add-wishes', [InvitationController::class, 'storeWishes'])->name('add-wishes');
});
...
Route::prefix('admin')->name('admin.')->group(function(){
    ...
    Route::middleware('auth')->group(function() {
        ...
        Route::post('/daftar-wish/delete/{id}', [AdminController::class, 'delete_wish'  ])->name('delete-wishes');
